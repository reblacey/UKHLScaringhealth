...
keep pidp *age_dv  *sf12pcs_dv  ageonset_all omidcare age_1ob_om agemax agemin kpscore sex hhid_1obya meanhour_omg placecare_om
...
combomarginsplot file1_om_yn file2_om_yn, labels ("carers" "non carers") savefile(combined_sfp_yn, replace)

mplotoffset using combined_sfp_yn, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 50-64") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))
...
combomarginsplot file1_om_yn_m file2_om_yn_m file1_om_yn_f file2_om_yn_f, labels ("male carers" "male non carers" "female carers" "female non carers") savefile(combined_sfp_yn_sex, replace)

mplotoffset using combined_sfp_yn_sex, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 50-64") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))



/////////////////////////////////graphs for care intensity 
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & meanhour_omg==1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_om_low, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & meanhour_omg==2|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_om_lmid, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & meanhour_omg==3|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_om_mid, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & (meanhour_omg==4|meanhour_omg==5) || hhid_1obya:,covariance(unstructured)mle var
...
combomarginsplot file1_om_low file1_om_lmid file1_om_mid file1_om_hig file1_om_ncare, labels ("<5h per week" "5-9h per week" "10-19h per week" "20+h per week" "non carers") savefile(combined_sfp_intensity, replace)

mplotoffset using combined_sfp_intensity, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 50-64") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))


/////////////////////////////////graphs for care place

mixed sf12pcs_dv i.poyrtoset if kpscore==1 & (placecare_om==1|placecare_om==3)|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_om_in, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & (placecare_om==2)|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_om_out, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==0|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_om_nocare, replace)

combomarginsplot file1_om_in file1_om_out file1_om_nocare, labels ("inside household care" "outside household care" "non carers") savefile(combined_sfp_place, replace)

mplotoffset using combined_sfp_place, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 50-64") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))
