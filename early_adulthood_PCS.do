...
combomarginsplot file1_y_yn file2_y_yn, labels ("carers" "non carers") savefile(combined_sfp_yn, replace)
mplotoffset using combined_sfp_yn, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 16-29") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))




/////////////////////////////////graphs for yes/no care by sex
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & sex==1&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_yn_m, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==0 & sex==1&poyrtoset!=0&poyrtoset<15&poyrtoset!=1 || hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file2_yn_m, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & sex==2&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_yn_f, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==0 & sex==2&poyrtoset!=0&poyrtoset<15&poyrtoset!=1 || hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file2_yn_f, replace)
combomarginsplot file1_yn_m file2_yn_m file1_yn_f file2_yn_f, labels ("male carers" "male non carers" "female carers" "female non carers") savefile(combined_sfp_yn_sex, replace)

mplotoffset using combined_sfp_yn_sex, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 16-29") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))



/////////////////////////////////graphs for care intensity (small N at two ends, excluded)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & meanhour_g==1&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_low, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & meanhour_g==2&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_lmid, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & meanhour_g==3&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_mid, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & poyrtoset!=0 & (meanhour_g==4|meanhour_g==5)&poyrtoset<15 &poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_hig, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==0 & poyrtoset!=0&poyrtoset<15 &poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_ncare, replace)
combomarginsplot file1_low file1_lmid file1_mid file1_hig file1_ncare, labels ("<5h per week" "5-9h per week" "10-19h per week" "20+h per week" "non carers") savefile(combined_sfp_intensity, replace)

mplotoffset using combined_sfp_intensity, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 16-29") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))


/////////////////////////////////graphs for care place

mixed sf12pcs_dv i.poyrtoset if kpscore==1 & (placecare==1|placecare==3)&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_in, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==1 & (placecare==2)&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_out, replace)
mixed sf12pcs_dv i.poyrtoset if kpscore==0&poyrtoset!=0&poyrtoset<15&poyrtoset!=1|| hhid_1obya:,covariance(unstructured)mle var
margins i.poyrtoset,saving(file1_nocare, replace)

combomarginsplot file1_in file1_out file1_nocare, labels ("inside household care" "outside household care" "non carers") savefile(combined_sfp_place, replace)

mplotoffset using combined_sfp_place, xline(7,lpattern(shortdash)lcolor(gray)) xline(8,lpattern(shortdash)lcolor(gray)) title("Age 16-29") xtitle ("Years centred on care onset year") ytitle (SF12-PCS) xlabel(0 "-8" 1 "-7" 2 "-6" 3 "-5" 4 "-4" 5 "-3" 6 "-2" 7 "-1" 8 "0" 9 "1" 10 "2" 11 "3" 12 "4" 13 "5" 14 "6" 15 "7" 16 "8")ciopts(msize(vsmall))
